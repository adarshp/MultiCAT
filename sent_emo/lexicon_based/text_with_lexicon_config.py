...
EXPERIMENT_DESCRIPTION = "Emolexicon_EmoRoberta_sentemo_"
...
model_params = Namespace(
    ...
    model="Multitask",
    # 'model_type' identifies the specific model to grab from huggingface
    # currently tested options are: roberta-base, arpanghoshal/EmoRoBERTa,
    # cardiffnlp/twitter-roberta-base-sentiment-latest, and
