...
def load_data(config):
    ...
    # convert to dataset
    all_data = MultitaskObject(train_data, dev_data, None, loss_fx)
...
if __name__ == "__main__":
    ...
    import baselines.sent_emo.lexicon_based.text_with_lexicon_config as config
    ...
    with open(os.path.join(output_path, "all_trials.csv"), "a") as writef:
        writef.write(
            f"{date.today()},{config.model_params.model_type},{config.model_params.lr},"
        )
        writef.write(
