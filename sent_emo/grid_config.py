...
EXPERIMENT_DESCRIPTION = "GridSearch_RobertaVariants_"
...
# select the number of times to select parameters
num_searches = 10
...
model_params = Namespace(
    ...
    model="Multitask",
    modality="text",  # text or multimodal
    # model_type="roberta-base",
    model_type=["cardiffnlp/twitter-roberta-base-emotion"],
    # model_type="arpanghoshal/EmoRoBERTa",
    # optimizer parameters
    # --------------------------------------------------
    # learning rate
    # with multiple tasks, these learning rates tend to be pretty low
    # (usually 1e-5 for roberta fine-tuning, 1e-3 to 1e-4 for LSTM)
    lr=1e-5,
    ...
    fc_hidden_dim=[
        768
    ],  # 20,  must match output_dim if final fc layer removed from base model
    final_hidden_dim=[
        192,
        384,
        768,
    ],  # the out size of dset-specific fc1 and input of fc2
