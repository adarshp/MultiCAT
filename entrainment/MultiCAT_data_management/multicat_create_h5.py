...
if __name__ == "__main__":
    ...
    if not h5_output_directory.exists():
        ...
        print(
            f"Could not find specified output directory {h5_output_directory}. Creating directory..."
        )
    else:
        print(
            f"Specified output directory {h5_output_directory} already exists. Continuing..."
        )
